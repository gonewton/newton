...
parity_test!(test_list_products, Method::GET, "/products", StatusCode::OK);
parity_test!(
...
parity_test!(test_list_repos, Method::GET, "/repos", StatusCode::OK);
parity_test!(
    test_list_repo_deps,
    Method::GET,
    "/repo-dependencies",
