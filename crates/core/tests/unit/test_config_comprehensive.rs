...
use newton_core::core::config::{ConfigLoader, NewtonConfig};
...
fn test_config_serialization_roundtrip() {
    let original_config = NewtonConfig {
        project: newton_core::core::config::ProjectConfig {
            name: "test-project".to_string(),
            template: Some("test-template".to_string()),
        },
        executor: newton_core::core::config::ExecutorConfig {
            coding_agent: "test-agent".to_string(),
            coding_agent_model: "test-model".to_string(),
            auto_commit: true,
        },
        evaluator: newton_core::core::config::EvaluatorConfig {
