...
async fn test_scenario_14_error_fallback() {
    ...
    assert_eq!(
        ...
        newton_core::workflow::executor::TaskStatus::Failed
    );
}
...
async fn test_scenario_15_retry_backoff() {
    ...
    assert_eq!(
        ...
        newton_core::workflow::executor::TaskStatus::Success
    );
...
async fn test_scenario_17_checkpoint_resume() {
    ...
    {
        let mut checkpoint = newton_core::workflow::checkpoint::load_checkpoint(
        ...
        newton_core::workflow::checkpoint::save_checkpoint(
            harness.temp_dir.path(),
            &execution_id,
            &checkpoint,
            false,
