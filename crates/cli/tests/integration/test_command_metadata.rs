...
fn category_bindings_match_spec_4_1() {
    ...
    let expected: &[(&str, &str)] = &[
        ...
        ("dependency/discover", categories::WORKFLOW),
        ("dependency/inspect", categories::WORKFLOW),
        ("dependency/approve", categories::WORKFLOW),
        ("dependency/impact", categories::WORKFLOW),
