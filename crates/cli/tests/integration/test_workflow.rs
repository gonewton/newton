...
use newton_core::core::OptimizationOrchestrator;
use newton_core::utils::serialization::{JsonSerializer, FileUtils};
use newton_core::core::error::DefaultErrorReporter;
...
async fn test_full_optimization_workflow() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let config = newton_core::core::entities::ExecutionConfiguration {
