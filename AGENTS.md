...
NEWTON-0028 - Whenever a backend CRUD endpoint is added or modified, you MUST regenerate `openapi/newton-api.yaml` by running `./scripts/generate-openapi.sh` and commit the updated file in the same PR
