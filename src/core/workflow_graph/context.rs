//! Context resolution and value processing utilities for workflow execution.
#![allow(clippy::result_large_err)] // Context module returns AppError to preserve structured diagnostic context; boxing would discard run-time state.
...
use crate::core::workflow_graph::state::TaskRunRecord;
